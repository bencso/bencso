...
📚 Currently, I am focused on learning <b>HTML5, CSS3, SASS, Bootstrap, TailwindCSS, JavaScript, NodeJS, VueJS, AngularJS , Python and C# </b> I'm really excited to see where these skills will take me!  <br> 
<i> Jelenleg a <b>HTML5, CSS3, SASS, Bootstrap, TailwindCSS, JavaScript, NodeJS, VueJS, AngularJS , Python és C#</b> tanulására koncentrálok. Nagyon izgatottan várom, hogy hova vezetnek majd ezek a készségek! </i>
###
